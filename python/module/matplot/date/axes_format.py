...
# MinuteLocator , HourLocator , DayLocator , WeekdayLocator , MonthLocator , YearLocator
# default: matplotlib.ticker.AutoDateLocator matplotlib.ticker.AutoDateFormatter
