...
class Severity(object):
    ...
    def __lt__(self, other):
        return operator.lt(self.level, other.level)

    def __le__(self, other):
        return operator.le(self.level, other.level)

    def __ge__(self, other):
        return operator.ge(self.level, other.level)

    def __gt__(self, other):
        return operator.gt(self.level, other.level)

    def __eq__(self, other):
        return operator.eq(self.level, other.level)

    def __ne__(self, other):
        return operator.ne(self.level, other.level)
