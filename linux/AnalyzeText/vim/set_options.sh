...
:set nonumber               no numbers on the left side.
:set invnumber              toggle on/off number option
:set sw                     Sets the width of a software tabstop. For example you would set a shift width of 4 with this command:
...
:set nohlsearch             no highlight of search
