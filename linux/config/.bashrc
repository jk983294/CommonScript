...
alias gitcp='git st | grep "modified:" | sed -e "s/modified: //g" | xargs -I{} cp -v --parents {} ~/junk/junk/src'
alias chrome='google-chrome'
alias cheat='less ~/github/MyTmp/sim/cheat.sh'
alias cdgit='cd ~/github/'
alias cdvis='cd ~/github/midas/visualization'
alias cdata='cd /dat/ctp'
alias cdconf='cd /opt/version/latest/etc'
alias cdz='cd /opt/version/latest/'
alias cdbin='cd /opt/version/latest/bin'
alias cdlog='cd /var/tmp/log'
...
alias vimd='vim /dat/ctp/trading_day.txt'
